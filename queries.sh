...
#echo "$($PSQL "SELECT T.name FROM teams AS T JOIN games AS G ON T.team_id=G.winner_id OR T.team_id=G.opponent_id  WHERE year=2014 AND round='Eighth-Final' ORDER BY name ASC")"
